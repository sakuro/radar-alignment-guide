...
-- installs those with `_G.storage = ...` and `_G.rendering = ...`, and the specs
-- then use them bare, which luacheck cannot follow back to those assignments.
files["spec/**/*_spec.lua"] = { globals = { "storage" }, read_globals = { "rendering" } }
